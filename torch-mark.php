                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/TORCH/TORCH MARK (2).jpg" alt="">
                                        <a href="images/portfolio/TORCH/TORCH MARK (2).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    ...
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/TORCH/TORCH MARK 5.jpg"   alt="">
                                        <a href="images/portfolio/TORCH/TORCH MARK 5.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        
                                    </div>
                                    <!-- swiper-slide end-->                                      
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/TORCH/TORCH MARK 6.jpg"   alt="">
                                        <a href="images/portfolio/TORCH/TORCH MARK 6.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/TORCH/TORCH MARK 8.jpg"   alt="">
                                        <a href="images/portfolio/TORCH/TORCH MARK 8.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                    ...
                                    <div class="swiper-slide ss_last" >
                                        <a class="next-project-wrap ajax fl-wrap" href="uyo-hotel.php">
                                            <div class="ss_pag-img">
                                                <div class="bg"  data-bg="images/bg/1.jpg"></div>
                                            </div>
                                            <strong>Next Project</strong>
                                            <span>Uyo Hotel<i class="fal fa-long-arrow-right"></i></span>
                                        </a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                </div>
