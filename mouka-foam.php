                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM (7).jpg" alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM (7).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->  
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM (8).jpg"   alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM (8).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end-->                                      
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM 3.jpg"   alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM 3.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM 4.jpg"   alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM 4.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM 6.jpg"   alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM 6.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/MOUKA/MOUKA FOAM.jpg"   alt="Mouka Foam">
                                        <a href="images/portfolio/MOUKA/MOUKA FOAM.jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                    ...
                                    <div class="swiper-slide ss_last" >
                                        <a class="next-project-wrap ajax fl-wrap" href="primewater.php">
                                            <div class="ss_pag-img">
                                                <div class="bg"  data-bg="images/bg/1.jpg"></div>
                                            </div>
                                            <strong>Next Project</strong>
                                            <span>Primewater View Gardens<i class="fal fa-long-arrow-right"></i></span>
                                        </a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                </div>
                                ...
                                <div class="project-details_container fl-wrap">
                                    ...
                                    <div class="pr-list dark-bg fl-wrap">
                                        <ul>
                                            ...
                                            <li><span>Location : </span> Ogba, Lagos </li>
                                        </ul>
