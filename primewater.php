                ...
                <div class="content-holder">
                    ...
                    <div class="fw-carousel-wrap fsc-holder single_project_carousel">
                        <div class="fsc-holder_title">
                                <h2>Primewater View<br>Gardens</h2>
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/PRIME/PWV ( FURNITURE CONSULTANCY 2).jpg" alt="">
                                        <a href="images/portfolio/PRIME/PWV ( FURNITURE CONSULTANCY 2).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    ...
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/PRIME/PWV (FURNITURE CONSULTANCY 1).jpg"   alt="">
                                        <a href="images/portfolio/PRIME/PWV (FURNITURE CONSULTANCY 1).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        
                                    </div>
                                    <!-- swiper-slide end-->                                      
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/PRIME/PWV (INTERIOR DESIGN MGT 1).jpg"   alt="">
                                        <a href="images/portfolio/PRIME/PWV (INTERIOR DESIGN MGT 1).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                        
                                    </div>
                                    <!-- swiper-slide end--> 
                                    <!-- swiper-slide-->  
                                    <div class="swiper-slide hov_zoom">
                                        <img  src="images/portfolio/PRIME/PWV (INTERIOR DESIGN MGT 2).jpg"   alt="">
                                        <a href="images/portfolio/PRIME/PWV (INTERIOR DESIGN MGT 2).jpg" class="box-media-zoom   popup-image"><i class="fal fa-search"></i></a>
                                    ...
                                    <div class="swiper-slide ss_last" >
                                        <a class="next-project-wrap ajax fl-wrap" href="torch-mark.php">
                                            <div class="ss_pag-img">
                                                <div class="bg"  data-bg="images/bg/1.jpg"></div>
                                            </div>
                                            <strong>Next Project</strong>
                                            <span>Torch Mark<i class="fal fa-long-arrow-right"></i></span>
                                        </a>
                                    </div>
                                    <!-- swiper-slide end--> 
                                </div>
                                ...
                                <div class="project-details_container fl-wrap">
                                    ...
                                    <div class="modal-content fl-wrap">
                                        <p>TURNKEY PROJECT: We fully
                                            ...
                                            Fabrication. <br>
                                            3) Interior design project. <br>
                                            Interior electrical, fittings & Lighting
                                            management.</p>
                                    </div>
                                    <div class="pr-list dark-bg fl-wrap">
                                        <ul>
                                            <li><span>Status :</span> Completed </li>
                                            <li><span>Location : </span> Lekki Phase I </li>
                                        </ul>
